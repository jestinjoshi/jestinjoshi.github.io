                ...
                <div className="flex justify-center gap-5 sm:gap-20 flex-wrap items-center">
                    ...
                    <div className="about flex-1 text-center lg:text-left">
                        ...
                        <motion.div initial={initialFadeUp} animate={fadeIn(1.3)} className="inline-flex mt-12 items-center">
                            ...
                            <a className="px-2 text-sm md:text-base md:px-4 py-3 rounded-lg ml-0 transition text-white flex items-center font-semibold resume glass glass-hover group overflow-hidden hover:pl-12 transition-all" href="/resume.pdf" target="_blank" rel="noreferrer">
