            ...
            <div className="custom-container px-5 mx-auto">
                <div className="flex justify-center gap-5 sm:gap-20 flex-wrap items-center">
                    ...
                    <div className="about flex-1 text-center lg:text-left">
                        <motion.h1 initial={initialFadeUp} animate={fadeIn(0.7)} className="text-3xl sm:text-5xl mb-5">{greeting.length ? greeting : ''}<span className="cursor"></span>, I&apos;m <span className="gradient-text">Jestin</span></motion.h1>
