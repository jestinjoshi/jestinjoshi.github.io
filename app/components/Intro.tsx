            ...
            <div className="custom-container px-4 mx-auto">
                <div className="flex justify-center gap-20 flex-wrap items-center">
                    ...
                    <div className="about flex-1">
                        ...
                        <p className="text-lg mb-5 text-justify">I am a frontend web developer with a track record of {calculateExperience()}+ years in developing websites across diverse categories, including blogs, e-commerce, dashboards, and static sites. I love solving complex problems with cutting-edge web technologies, implementing challenging UI interactions and components; and collaborating with talented teams.</p>

                        <p className="text-lg mb-5 text-justify">I am always eager to learn new skills and explore new challenges. Currently, I&apos;m keen on delving into backend technologies, CI/CD, and database development as I am inclined to become a fullstack developer in the future.</p>
                        <div className="inline-flex mt-12 items-center">
                            ...
                            <a className="px-2 text-sm md:text-base md:px-4 py-3 rounded-lg ml-0 transition text-white flex items-center font-semibold resume" href="/Resume_Jestin.pdf" target="_blank" rel="noreferrer">
