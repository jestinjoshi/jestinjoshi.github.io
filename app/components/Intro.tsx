        ...
        <section id="about" className="py-10">
            <div className="custom-container px-4 mx-auto">
                <div className="flex justify-center gap-20 flex-wrap items-center">
                    <motion.div initial={{...initialFadeUp, scale: 0}} animate={{...fadeIn(0.5), scale: 1}} className="avatar-wrap relative w-full sm:w-[300px]">
                    ...
                    <div className="about flex-1">
                        <motion.h1 initial={initialFadeUp} animate={fadeIn(0.7)} className="text-5xl mb-5">{greeting.length ? greeting : ''}<span className="cursor"></span>, I&apos;m <span className="gradient-text">Jestin</span></motion.h1>
                        <motion.p initial={initialFadeUp} animate={fadeIn(0.9)} className="text-lg mb-5 text-justify">I am a frontend web developer with a track record of {calculateExperience()}+ years in developing websites across diverse categories, including blogs, e-commerce, dashboards, and static sites. I love solving complex problems with cutting-edge web technologies, implementing challenging UI interactions and components; and collaborating with talented teams.</motion.p>

                        <motion.p initial={initialFadeUp} animate={fadeIn(1.1)} className="text-lg mb-5 text-justify">I am always eager to learn new skills and explore new challenges. Currently, I&apos;m keen on delving into backend technologies, CI/CD, and database development as I am inclined to become a fullstack developer in the future.</motion.p>
                        <motion.div initial={initialFadeUp} animate={fadeIn(1.3)} className="inline-flex mt-12 items-center">
                            <a aria-label="Github" href="https://github.com/jestinjoshi/" target="_blank" rel="noreferrer" className="mr-8 text-white transition">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-github"><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"></path></svg>
                            </a>
                            <a aria-label="LinkedIn" href="https://linkedin.com/in/jestinjoshi/" target="_blank" rel="noreferrer" className="mr-8 text-white transition">
                            ...
                            <a className="px-2 text-sm md:text-base md:px-4 py-3 rounded-lg ml-0 transition text-white flex items-center font-semibold resume glass" href="/Resume_Jestin.pdf" target="_blank" rel="noreferrer">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-download mr-2"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="7 10 12 15 17 10"></polyline><line x1="12" y1="15" x2="12" y2="3"></line></svg>Resume</a>
                        </motion.div>
                    </div>
                </div>
            </div>
